...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModel.navigateToSleepQualityFragmentEvent.observe(viewLifecycleOwner, Observer { night ->
            night?.let {
                this.findNavController().navigate(SleepTrackerFragmentDirections
                        .actionSleepTrackerFragmentToSleepQualityFragment(night.nightId))
                viewModel.onNavigateToSleepQualityFragmentEventComplete()
            }
        })
        ...
        viewModel.showSnackbarEvent.observe(viewLifecycleOwner, Observer {
            if (it == true) {
                ...
                viewModel.onShowSnackbarEventComplete()
            }
        })
        ...
        viewModel.navigateToSleepDetailFragmentEvent.observe(viewLifecycleOwner, Observer { nightId ->
            nightId?.let {
